        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">ammarjamal032@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8" >+91- 77027-26193</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Residential Address:</strong></div>
              <div class="col-sm-8">Madhura Hill, Shaikpet,
                Hyderabad
                Telangana -500008. </div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Permanent Address:</strong></div>
              <div class="col-sm-8">Pura Rani,
                Mubarakpur, Azamgarh, U.P.
                India 276404 </div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
              <div class="col-sm-8">English, Urdu, Hindi</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="ml-auto mr-auto">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                  <figure class="cc-effect"><img src="images/project4.png" alt="Image"/>
                    <figcaption>
                      <div class="h4">Academic Project</div>
                      <p>Time Table Management System</p>
                    </figcaption>
                  </figure></a></div>
            </div>
          </div>
...
?>
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <a class="category" href="https://www.hcltech.com/">HCL TECH</a>
            <p>
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <a class="category" href="https://manuu.edu.in/">Maulana Azad National Urdu University</a>
           <p>The Master of Computer Science or Master of Computer Application (MCA) is a type of Master's degree, usually awarded after three years of collegiate study in computer science, In general, computer science degree programs emphasize the mathematical and theoretical foundations of computing</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <a class="category" href="http://www.vbspu.ac.in/" >Veer Bahadur Singh Purvanchal University</a>
           
            <p>Bachelor of Science(B.Sc.) is a three years course that deals with a variety of research-oriented studies of science under several 
              streams and also focuses on application of science concepts in real-life scenarios. The course is built on science fundamentals 
              and consists of various specialization streams such as Physics, Chemistry, Mathematics.</p>
    ...
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2012 - 2015</p>
            <div class="h5">Intermediate & <br>High School </div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Science and Mathematics</div>
            <a class="category" href="https://upmsp.edu.in/">UP Board</a>
            <!--<p>Euismod massa scelerisque suspendisse fermentum habitant vitae ullamcorper
            magna quam iaculis, tristique sapien taciti mollis interdum sagittis libero nunc inceptos
            tellus, hendrerit vel eleifend primis lectus quisque cubilia sed mauris. Lacinia porta
            vestibulum diam integer quisque eros pulvinar curae, curabitur feugiat arcu vivamus parturient
            aliquet laoreet at, eu etiam pretium molestie ultricies sollicitudin dui.</p>
            -->
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-10 col-md-9">
                <p> Habitasse venenatis commodo tempor eleifend arcu sociis sollicitudin ante pulvinar ad,
                  ...
                  donec nam ullamcorper, laoreet nullam mauris dui aptent facilisis neque elementum ac,
                  risus semper felis parturient fringilla rhoncus eleifend.</p>
          ...
          <div class="carousel-item">
            <div class="row">
              ...
              <div class="col-lg-10 col-md-9">
                ...
                <p> Habitasse venenatis commodo tempor eleifend arcu sociis sollicitudin ante pulvinar ad,
                est porta cras erat ullamcorper volutpat metus duis platea convallis, tortor primis ac quisque
                etiam luctus nisl nullam fames. Ligula purus suscipit tempus nascetur curabitur donec nam
                ullamcorper, laoreet nullam mauris dui aptent facilisis neque elementum ac, risus semper
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/map.png')">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <form action="https://formspree.io/f/meqvjryo" method="POST">
                      ...
                      <div class="row">
                        <div class="col">
                          <button class="btn btn-primary" type="submit" target="_blank">Send</button>
                        </div>
                      </div>
                    </form>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    <p class="mb-0"><strong>Residential Address </strong></p>
                    <p class="pb-0">Madhura Hill, Shaikpet,
                      Hyderabad
                      Telangana -500008.</p>

                    <p class="mb-0"><strong>Permanent Address </strong></p>
                    <p class="pb-2">Pura Rani,
                      Mubarakpur, Azamgarh, U.P.
                      India 276404 </p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2">+91- 7702726193</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>ammarjamal032@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">AMMAR JAMAL</div>
